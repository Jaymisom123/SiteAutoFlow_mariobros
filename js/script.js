...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (whatsappFloat && whatsappTooltip) {
        ...
        function showTooltipPeriodically() {
            if (!isHovering) {
                whatsappTooltip.style.opacity = '1';
                whatsappTooltip.style.transform = 'translateY(0) scale(1)';
                
                setTimeout(() => {
                    if (!isHovering) {
                        whatsappTooltip.style.opacity = '0';
                        whatsappTooltip.style.transform = 'translateY(10px) scale(0.8)';
                    }
                }, 3000);
            }
        }

        // Show tooltip every 15 seconds
        setInterval(showTooltipPeriodically, 15000);
    ...
    // WhatsApp click tracking and animation
    whatsappBtn?.addEventListener('click', function(e) {
        ...
        // Add extra pulse animation on click
    ...
    // Replace regular scroll listeners with throttled versions
